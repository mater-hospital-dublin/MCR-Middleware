...
public class ReferralDocumentDetailsQueryStrategy extends AbstractQueryStrategy<ReferralDocumentDetails> {
    ...
    public String getQuery(String namespace, String patientId) {
        return "select a/uid/value as uid, a/context/start_time/value as referralDateTime, a/composer/name as authorName, a/context/health_care_facility/name as facility, " +
                ...
                "a/content[openEHR-EHR-SECTION.referral_details_rcp.v1|Referral details|]/items[openEHR-EHR-INSTRUCTION.request.v0|Service request|]/protocol[at0008]/items[openEHR-EHR-CLUSTER.distribution.v1|Distribution|]/items[at0011|Individual recipient|]/items[openEHR-EHR-CLUSTER.organisation.v1|GP|]/items[at0001|Name of Organisation|]/value/value as providerContactOrgName, " +
                "a/content[openEHR-EHR-SECTION.referral_details_rcp.v1|Referral details|]/items[openEHR-EHR-INSTRUCTION.request.v0|Service request|]/protocol[at0008]/items[openEHR-EHR-CLUSTER.distribution.v1|Distribution|]/items[at0011|Individual recipient|]/items[openEHR-EHR-CLUSTER.organisation.v1|GP|]/items[at0011|Identifier|]/value/value as providerContactId, " +
                "a/content[openEHR-EHR-SECTION.referral_details_rcp.v1|Referral details|]/items[openEHR-EHR-INSTRUCTION.request.v0|Service request|]/protocol[at0008]/items[openEHR-EHR-CLUSTER.distribution.v1|Distribution|]/items[at0011|Individual recipient|]/items[openEHR-EHR-CLUSTER.organisation.v1|GP|]/items[openEHR-EHR-CLUSTER.telecom_uk.v1|WPN|]/items[at0002|Work number|]/value/value as providerContactWorkNumber, " +
                "a/content[openEHR-EHR-SECTION.referral_details_rcp.v1|Referral details|]/items[openEHR-EHR-INSTRUCTION.request.v0|Service request|]/protocol[at0008]/items[openEHR-EHR-CLUSTER.distribution.v1|Distribution|]/items[at0011|Individual recipient|]/items[openEHR-EHR-CLUSTER.organisation.v1|GP|]/items[openEHR-EHR-CLUSTER.telecom_uk.v1|WPN|]/items[at0002|Work number|]/value/value as providerContactEmgNumber, " +
                "a/content[openEHR-EHR-SECTION.referral_details_rcp.v1|Referral details|]/items[openEHR-EHR-INSTRUCTION.request.v0|Service request|]/protocol[at0008]/items[openEHR-EHR-CLUSTER.distribution.v1|Distribution|]/items[at0011|Individual recipient|]/items[openEHR-EHR-CLUSTER.organisation.v1|GP|]/items[openEHR-EHR-CLUSTER.telecom_uk.v1|WPN|]/items[at0002|Work number|]/value/value as providerContactEmail, " +
