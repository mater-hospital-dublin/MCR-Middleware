 ...
 */
package ie.mater.patient.heightandweight.rest;

import java.util.List;

import ie.mater.patient.heightandweight.search.HeightAndWeightSearch;
import ie.mater.patient.heightandweight.search.HeightAndWeightSearchFactory;
import ie.mater.patient.heightandweight.store.HeightAndWeightStore;
import ie.mater.patient.heightandweight.model.HeightAndWeightDetails;
import ie.mater.patient.heightandweight.store.HeightAndWeightStoreFactory;
