 ...
 */
package ie.mater.patient.clinicalnotes.rest;

import java.util.List;

import ie.mater.patient.clinicalnotes.model.ClinicalNoteDetails;
import ie.mater.patient.clinicalnotes.model.ClinicalNoteSummary;
import ie.mater.patient.clinicalnotes.search.ClinicalNoteSearch;
import ie.mater.patient.clinicalnotes.store.ClinicalNoteStore;
import ie.mater.patient.clinicalnotes.search.ClinicalNoteSearchFactory;
import ie.mater.patient.clinicalnotes.store.ClinicalNoteStoreFactory;
