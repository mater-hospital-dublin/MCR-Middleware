...
public class OpenEHRClinicalNoteStore extends AbstractOpenEhrService implements ClinicalNoteStore {
    ...
    public void create(String patientId, ClinicalNoteDetails clinicalNote) {
        Map<String, Object> content = createFlatJsonContent(clinicalNote);

        CreateStrategy createStrategy = new DefaultStoreStrategy(patientId, clinicalNotesTemplate, content);
    ...
    public void update(String patientId, ClinicalNoteDetails clinicalNote) {
        ...
        UpdateStrategy updateStrategy = new DefaultStoreStrategy(clinicalNote.getSourceId(), patientId,
