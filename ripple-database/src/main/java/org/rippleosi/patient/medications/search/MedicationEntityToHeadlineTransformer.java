...
public class MedicationEntityToHeadlineTransformer implements Transformer<MedicationEntity, MedicationHeadline> {

    @Override
    public MedicationHeadline transform(MedicationEntity entity) {
        MedicationHeadline headline = new MedicationHeadline();

        headline.setSourceId(String.valueOf(entity.getId()));
        headline.setSource("Crimson Tide iOS");
        headline.setName(entity.getName());
